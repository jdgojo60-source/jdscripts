...
local Window = OrionLib:MakeWindow({Name = "JDSCRIPTS HUB", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "JDSCRIPTS HUB"})
...
W:AddLabel("[+] JDSCRIPTS HUB is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "JDSCRIPTS HUB(Noitification)",
